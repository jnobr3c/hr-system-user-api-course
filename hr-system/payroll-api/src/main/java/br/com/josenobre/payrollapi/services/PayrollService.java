package br.com.josenobre.payrollapi.services;

import br.com.josenobre.payrollapi.domain.Payroll;
import br.com.josenobre.payrollapi.feignClients.UserFeign;
import br.com.josenobre.payrollapi.services.exceptions.ObjectNotFoundException;
...
public class PayrollService {
    ...
    public Payroll getPayment(Long workerId, Payroll payroll) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Illegal argument exceptiom");
        }
        return null;
    }
}
